...
export interface IMintBurnERC20Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
...
export interface IMintBurnERC20 extends BaseContract {
  connect(runner?: ContractRunner | null): IMintBurnERC20;
  waitForDeployment(): Promise<this>;

  interface: IMintBurnERC20Interface;
