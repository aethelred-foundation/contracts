...
export interface IAccessManagedInterface extends Interface {
  ...
  getEvent(
    nameOrSignatureOrTopic: "AuthorityUpdated" | "AuthorityUpdated(address)"
  ): EventFragment;
...
export interface IAccessManaged extends BaseContract {
  ...
  "setAuthority(address)": TypedContractMethod<
    [arg0: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "setAuthority(address)"
  ): TypedContractMethod<[arg0: AddressLike], [void], "nonpayable">;
  ...
  >;
  getEvent(
    key: "AuthorityUpdated(address)"
  ): TypedContractEvent<
    AuthorityUpdated_address_Event.InputTuple,
    AuthorityUpdated_address_Event.OutputTuple,
    AuthorityUpdated_address_Event.OutputObject
  >;
