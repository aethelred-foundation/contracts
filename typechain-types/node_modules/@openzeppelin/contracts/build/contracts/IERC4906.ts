...
export interface IERC4906 extends BaseContract {
  ...
  >;
  getEvent(
    key: "BatchMetadataUpdate(uint256,uint256)"
  ): TypedContractEvent<
    BatchMetadataUpdate_uint256_uint256_Event.InputTuple,
    BatchMetadataUpdate_uint256_uint256_Event.OutputTuple,
    BatchMetadataUpdate_uint256_uint256_Event.OutputObject
  >;
  getEvent(
    key: "MetadataUpdate"
  ): TypedContractEvent<
  ...
  >;
  getEvent(
    key: "MetadataUpdate(uint256)"
  ): TypedContractEvent<
    MetadataUpdate_uint256_Event.InputTuple,
    MetadataUpdate_uint256_Event.OutputTuple,
    MetadataUpdate_uint256_Event.OutputObject
  >;
  getEvent(
    key: "Transfer"
  ): TypedContractEvent<
