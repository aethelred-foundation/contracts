...
export interface ERC721Wrapper extends BaseContract {
  ...
  "depositFor(address,uint256[])": TypedContractMethod<
    [account: AddressLike, tokenIds: BigNumberish[]],
    [boolean],
    "nonpayable"
  >;
  ...
  "withdrawTo(address,uint256[])": TypedContractMethod<
    [account: AddressLike, tokenIds: BigNumberish[]],
    [boolean],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "depositFor(address,uint256[])"
  ): TypedContractMethod<
    [account: AddressLike, tokenIds: BigNumberish[]],
    [boolean],
    "nonpayable"
  ...
  >;
  getFunction(
    nameOrSignature: "withdrawTo(address,uint256[])"
  ): TypedContractMethod<
    [account: AddressLike, tokenIds: BigNumberish[]],
    [boolean],
    "nonpayable"
