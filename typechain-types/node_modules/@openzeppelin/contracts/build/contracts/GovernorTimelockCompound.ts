...
export interface GovernorTimelockCompoundInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "updateTimelock(address)",
    values: [AddressLike]
  ): string;
...
export interface GovernorTimelockCompound extends BaseContract {
  ...
  "updateTimelock(address)": TypedContractMethod<
    [newTimelock: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "updateTimelock(address)"
  ): TypedContractMethod<[newTimelock: AddressLike], [void], "nonpayable">;
  getFunction(
  ...
  >;
  getEvent(
    key: "TimelockChange(address,address)"
  ): TypedContractEvent<
    TimelockChange_address_address_Event.InputTuple,
    TimelockChange_address_address_Event.OutputTuple,
    TimelockChange_address_address_Event.OutputObject
  >;
  getEvent(
    key: "VoteCast"
  ): TypedContractEvent<
