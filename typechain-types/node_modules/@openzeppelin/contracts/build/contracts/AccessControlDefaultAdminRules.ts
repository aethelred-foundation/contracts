...
export interface AccessControlDefaultAdminRules extends BaseContract {
  ...
  "beginDefaultAdminTransfer(address)": TypedContractMethod<
    [newAdmin: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  "changeDefaultAdminDelay(uint48)": TypedContractMethod<
    [newDelay: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "beginDefaultAdminTransfer(address)"
  ): TypedContractMethod<[newAdmin: AddressLike], [void], "nonpayable">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "changeDefaultAdminDelay(uint48)"
  ): TypedContractMethod<[newDelay: BigNumberish], [void], "nonpayable">;
  getFunction(
  ...
  getEvent(
    ...
    DefaultAdminDelayChangeCanceled__Event.InputTuple,
    DefaultAdminDelayChangeCanceled__Event.OutputTuple,
    DefaultAdminDelayChangeCanceled__Event.OutputObject
  >;
  getEvent(
  ...
  >;
  getEvent(
    key: "DefaultAdminDelayChangeScheduled(uint48,uint48)"
  ): TypedContractEvent<
    DefaultAdminDelayChangeScheduled_uint48_uint48_Event.InputTuple,
    DefaultAdminDelayChangeScheduled_uint48_uint48_Event.OutputTuple,
    DefaultAdminDelayChangeScheduled_uint48_uint48_Event.OutputObject
  >;
  getEvent(
  ...
  getEvent(
    ...
    DefaultAdminTransferCanceled__Event.InputTuple,
    DefaultAdminTransferCanceled__Event.OutputTuple,
    DefaultAdminTransferCanceled__Event.OutputObject
  >;
  getEvent(
  ...
  >;
  getEvent(
    key: "DefaultAdminTransferScheduled(address,uint48)"
  ): TypedContractEvent<
    DefaultAdminTransferScheduled_address_uint48_Event.InputTuple,
    DefaultAdminTransferScheduled_address_uint48_Event.OutputTuple,
    DefaultAdminTransferScheduled_address_uint48_Event.OutputObject
  >;
  getEvent(
