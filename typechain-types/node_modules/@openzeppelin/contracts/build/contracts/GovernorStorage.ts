...
export interface GovernorStorageInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "proposalDetails(uint256)",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "proposalDetailsAt(uint256)",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface GovernorStorage extends BaseContract {
  ...
  "proposalDetails(uint256)": TypedContractMethod<
    [proposalId: BigNumberish],
    [[string[], bigint[], string[], string]],
    "view"
  >;
  ...
  "proposalDetailsAt(uint256)": TypedContractMethod<
    [index: BigNumberish],
    [[bigint, string[], bigint[], string[], string]],
    "view"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "proposalDetails(uint256)"
  ): TypedContractMethod<
    [proposalId: BigNumberish],
    [[string[], bigint[], string[], string]],
    "view"
  ...
  >;
  getFunction(
    nameOrSignature: "proposalDetailsAt(uint256)"
  ): TypedContractMethod<
    [index: BigNumberish],
    [[bigint, string[], bigint[], string[], string]],
    "view"
