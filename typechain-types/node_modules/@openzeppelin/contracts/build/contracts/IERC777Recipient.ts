...
export interface IERC777RecipientInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "tokensReceived(address,address,address,uint256,bytes,bytes)",
    values: [
      AddressLike,
      AddressLike,
      AddressLike,
...
export interface IERC777Recipient extends BaseContract {
  ...
  "tokensReceived(address,address,address,uint256,bytes,bytes)": TypedContractMethod<
    [
      operator: AddressLike,
      from: AddressLike,
      to: AddressLike,
  ...
  >;
  getFunction(
    nameOrSignature: "tokensReceived(address,address,address,uint256,bytes,bytes)"
  ): TypedContractMethod<
    [
      operator: AddressLike,
      from: AddressLike,
