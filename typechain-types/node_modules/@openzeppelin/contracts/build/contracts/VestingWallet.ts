...
export interface VestingWallet extends BaseContract {
  ...
  >;
  getEvent(
    key: "ERC20Released(address,uint256)"
  ): TypedContractEvent<
    ERC20Released_address_uint256_Event.InputTuple,
    ERC20Released_address_uint256_Event.OutputTuple,
    ERC20Released_address_uint256_Event.OutputObject
  >;
  getEvent(
    key: "EtherReleased"
  ): TypedContractEvent<
  ...
  >;
  getEvent(
    key: "EtherReleased(uint256)"
  ): TypedContractEvent<
    EtherReleased_uint256_Event.InputTuple,
    EtherReleased_uint256_Event.OutputTuple,
    EtherReleased_uint256_Event.OutputObject
  >;
  getEvent(
