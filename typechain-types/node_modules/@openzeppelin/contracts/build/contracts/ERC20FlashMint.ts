...
export interface ERC20FlashMintInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
...
export interface ERC20FlashMint extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20FlashMint;
  ...
  "flashFee(address,uint256)": TypedContractMethod<
    [token: AddressLike, value: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  "flashLoan(address,address,uint256,bytes)": TypedContractMethod<
    [
      receiver: AddressLike,
      token: AddressLike,
      value: BigNumberish,
  ...
  "maxFlashLoan(address)": TypedContractMethod<
    [token: AddressLike],
    [bigint],
    "view"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "flashFee(address,uint256)"
  ): TypedContractMethod<
    [token: AddressLike, value: BigNumberish],
    [bigint],
    "view"
  ...
  >;
  getFunction(
    nameOrSignature: "flashLoan(address,address,uint256,bytes)"
  ): TypedContractMethod<
    [
      receiver: AddressLike,
      token: AddressLike,
  ...
  getFunction(
    nameOrSignature: "maxFlashLoan(address)"
  ): TypedContractMethod<[token: AddressLike], [bigint], "view">;
  getFunction(
